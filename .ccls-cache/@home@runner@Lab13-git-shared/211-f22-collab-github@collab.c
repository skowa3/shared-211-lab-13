...
void skowa3_avern4() {
  printf("Sebastian(seba) Kowalczyk, one thing that I learned with git commands was how to using git pull to merge changes made by multiple people in different files  \n");
  printf("Axel Vernooij, i learned how to use github with replit. one thing that was difficult was making sense of how to use some commands\n");
}
